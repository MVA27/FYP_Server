<?php
	...
	//otp.php?type=<get|update>&userName=mehulanvekar&password=newpw

	//This code is almost same as verify_user.php, the only difference in this code it that user password is not required
	...
	//'get' section requires only user name
	if($type == 'get'){
	...
	//'update' section requires user name and password
	else if($type == 'update'){
